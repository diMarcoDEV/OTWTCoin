...
uint256 hashGenesisBlock("0x89a2da48808f2af2f585a5827afb9bcb83b698c5b2abf4a841d5298c2481cab7");
...
const string strMessageMagic = "OTWTCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // OTWTCoin: 1 days
static const int64 nTargetSpacing = 120; // OTWTCoin: 120 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal otwtcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "OTWTCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x89b2e123296ad9d86cba3cf15f78fe81bdf77c53053e98486f1cb583288d4fb9");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "OTWLCoin - started on 2018-04-24";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1524674188; //20180425
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2973603;

        if (fTestNet)
        {
            block.nTime    = 1524570630; //20180424
            block.nNonce   = 857014;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x43e5abcb2a65dc53e39e5ec2d8c159b19543ff977bfd4e68bc800419d02e3d39"));

        // If genesis block hash does not match, then generate new genesis hash.
        //if (true && block.GetHash() != hashGenesisBlock) - deze alleen voor genesis block
